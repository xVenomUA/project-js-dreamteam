/* empty css                      */import{a as d}from"./assets/vendor-a61d8330.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const i of r)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function s(r){const i={};return r.integrity&&(i.integrity=r.integrity),r.referrerpolicy&&(i.referrerPolicy=r.referrerpolicy),r.crossorigin==="use-credentials"?i.credentials="include":r.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function o(r){if(r.ep)return;r.ep=!0;const i=s(r);fetch(r.href,i)}})();const a={categor:document.querySelector(".filter-categories"),filtercard:document.querySelector(".filter-cards"),form:document.querySelector(".filter-div-label"),filtersInput:document.getElementById("filter-search"),filtersCategories:document.querySelector(".filter-categories")},u="https://food-boutique.b.goit.study/api";async function $(){try{return(await d.get(`${u}/products/categories`)).data}catch(e){console.log(e)}}async function S(e,t,s,o,r,i,c){try{const l=new URLSearchParams({keyword:e||"",category:t||"",byABC:s||!1,byPrice:o||!1,byPopularity:r||!1,page:i,limit:c});return(await d.get(`${u}/products?${l.toString()}`)).data}catch(l){console.log(l.message)}}async function P(){try{return await d.get(`${u}/products/popular?limit=5`)}catch(e){console.log(e.message)}}async function L(){try{return await d.get(`${u}/products/discount`)}catch(e){console.log(e.message)}}async function k(e){return(await d.post(`${u}/subscription`,e)).data}const p="/project-js-dreamteam/assets/icon-c285a3d7.svg";function I(e){const t=e.map(({_id:s,category:o,img:r,name:i,size:c,popularity:l,price:y})=>`<div class="filt-div-card" data-idcarts="${s}">
...
`).join("");a.filtercard.innerHTML=t}const f={keyword:null},n={keyword:null,category:null,page:1,limit:6};window.addEventListener("resize",h);async function C(){try{const e=await $();e.push("Show all");const t=e.map(s=>`<option value="${s}">${s}</option>`).join("");a.categor.innerHTML+=t}catch(e){console.log(e)}}async function h(){const e=x();n.limit=e;const t=JSON.parse(localStorage.getItem("filters"));t&&(n.keyword=t.keyword,n.category=t.category,n.page=t.page,localStorage.setItem("filters",JSON.stringify(n)),b());try{const o=(await S(n.keyword,n.category,"","","",n.page,e)).results;I(o)}catch(s){console.log(s)}}C();h();a.form&&(a.form.addEventListener("input",E),a.form.addEventListener("submit",q));async function E(){const e=a.filtersInput.value;f.keyword=e,e===""&&(f.keyword=null),localStorage.setItem("keyword",JSON.stringify(f))}async function q(e){e.preventDefault();const t=a.filtersInput.value;n.keyword=t,t===""&&(n.keyword=null);const s=a.filtersCategories.value;n.category=s,s===""&&(n.category=null),s==="Show all"&&(n.category=null),localStorage.setItem("filters",JSON.stringify(n)),h()}function b(){try{const e=JSON.parse(localStorage.getItem("keyword"));a.filtersInput&&(a.filtersInput.value=e.keyword||"")}catch{return}}b();function x(){const e=window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth;return e>=1440?9:e>=768?8:6}function O(e){return`
