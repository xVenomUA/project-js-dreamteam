  ...
  <div class="filt-div-price"> 
    ...
    <button class="filt-btn-card" data-idcards="${s}" type="submit" >
      <svg class="filt-card-icon" height="18" width="18" >
          <use class="filt-use" href="${y}#icon-${m}"></use>
        </svg>
    </button>
  </div>
</div>
