import{i as p,a as A,g as x,A as B,b as H,c as D,p as W}from"./assets/icon-1835ad44.js";import{l as V}from"./assets/vendor-611745ce.js";const n={categor:document.querySelector(".filter-categories"),filtercard:document.querySelector(".filter-cards"),form:document.querySelector(".filter-div-label"),filtersInput:document.getElementById("filter-search"),filtersCategories:document.querySelector(".filter-categories"),addCartBtn:document.querySelector(".shop-btn-card"),listCards:document.querySelector(".filter-cards"),countHeader:document.querySelector(".header-cart-count"),PopularDiv:document.getElementById("popularContainer"),modalWindowId:document.getElementById("id-modal-card")};function f(){const t=JSON.parse(localStorage.getItem("cart"));t?n.countHeader.textContent=`(${t.length})`:n.countHeader.textContent="(0)"}f();function z(t){const e=t.map(({_id:s,category:o,img:r,name:c,size:a,popularity:i,price:l})=>{o.includes("_")&&(o=o.replace(/_/g," "));let d="",m="shop";const g=JSON.parse(localStorage.getItem("cart"));return g&&g.find(v=>v._id===s)&&(m="check",d="disabled"),`<div class="filt-div-card" data-idcarts="${s}">
...
`}).join("");n.PopularDiv.innerHTML=e}$();async function $(){try{const e=(await A()).data;F(e)}catch{}}n.PopularDiv.addEventListener("click",R);async function R(t){t.preventDefault();const{target:e}=t,s=e.closest(".popular-card");if(!s||e.closest(".popular-icon-cont"))return;const r=s.dataset.idcarts;try{const c=await x(r);w(c),n.modalWindowId.classList.remove("is-hidden-card")}catch(c){console.log(c)}}function j(t){h();const{target:e}=t,s=e.closest(".popular-icon-cont");if(!s)return;s.querySelector(".filt-use").setAttribute("href",`${p}#icon-check`),s.setAttribute("disabled","true"),s.classList.add("popular-icon-back");const c=s.dataset.idcarts,a=localStorage.getItem("cart"),i=JSON.parse(a);if(i){const l=i.find(d=>d._id===c);if(l){l.quantity+=1,localStorage.setItem("cart",JSON.stringify(i));return}i.push({_id:c,quantity:1}),localStorage.setItem("cart",JSON.stringify(i)),f();return}if(!i){const l=[];l.push({_id:c,quantity:1}),localStorage.setItem("cart",JSON.stringify(l)),f()}}n.PopularDiv.addEventListener("click",j);const S={keyword:null},u={keyword:null,category:null,page:1,limit:6};window.addEventListener("resize",V(h,2500));async function U(){try{const e=(await B()).map(o=>{let r;return o.includes("_")?r=o.replace(/_/g," "):r=o,`<option value="${o}">${r}</option>`}).join("");n.categor.innerHTML+=e;const s=document.createElement("option");s.value="Show all",s.textContent="Show all",n.categor.prepend(s)}catch(t){console.log(t)}}async function h(){const t=Q();u.limit=t;const e=JSON.parse(localStorage.getItem("filters"));e&&(u.keyword=e.keyword,u.category=e.category,u.page=e.page,localStorage.setItem("filters",JSON.stringify(u)),E());try{const s=await H(u.keyword,u.category,"","","",u.page,t);localStorage.setItem("totalPage",JSON.stringify(s.totalPages));const o=s.results;z(o)}catch(s){console.log(s)}}U();h();n.form&&(n.form.addEventListener("input",G),n.form.addEventListener("submit",K));async function G(){const t=n.filtersInput.value;S.keyword=t,t===""&&(S.keyword=null),localStorage.setItem("keyword",JSON.stringify(S))}async function K(t){t.preventDefault();const e=n.filtersInput.value;u.keyword=e,e===""&&(u.keyword=null);const s=n.filtersCategories.value;u.category=s,s===""&&(u.category=null),s==="Show all"&&(u.category=null),localStorage.setItem("filters",JSON.stringify(u)),h(),t.target.reset()}function E(){try{const t=JSON.parse(localStorage.getItem("keyword"));n.filtersInput&&(n.filtersInput.value=t.keyword||"")}catch{return}}E();function Q(){const t=window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth;return t>=1440?9:t>=768?8:6}function X(t){$();const{target:e}=t,s=e.closest(".filt-btn-card");if(!s)return;s.querySelector(".filt-use").setAttribute("href",`${p}#icon-check`),s.setAttribute("disabled","true");const r=s.dataset.idcards,c=localStorage.getItem("cart"),a=JSON.parse(c);if(a){const i=a.find(l=>l._id===r);if(i){i.quantity+=1,localStorage.setItem("cart",JSON.stringify(a));return}a.push({_id:r,quantity:1}),localStorage.setItem("cart",JSON.stringify(a)),f();return}if(!a){const i=[];i.push({_id:r,quantity:1}),localStorage.setItem("cart",JSON.stringify(i)),f()}}n.listCards.addEventListener("click",X);const N=document.querySelector(".pagination ul");let Y=10,Z=1;const tt=document.querySelector(".pagination");N.innerHTML=et(Y,Z);function et(t,e){let s="",o,r=e-1,c=e+1;e>1&&(s+=`<li class="btn prev" onclick="createPagination(totalPages, ${e-1})"><span><i class="fas fa-angle-left"></i> Prev</span></li>`),e>2&&(s+='<li class="first numb" onclick="createPagination(totalPages, 1)"><span>1</span></li>',e>3&&(s+='<li class="dots"><span>...</span></li>')),e==t?r=r-2:e==t-1&&(r=r-1),e==1?c=c+2:e==2&&(c=c+1);for(var a=r;a<=c;a++)a>t||(a==0&&(a=a+1),e==a?o="active":o="",s+=`<li class="numb ${o}" onclick="createPagination(totalPages, ${a})"><span>${a}</span></li>`);return e<t-1&&(e<t-2&&(s+='<li class="dots"><span>...</span></li>'),s+=`<li class="last numb" onclick="createPagination(totalPages, ${t})"><span>${t}</span></li>`),e<t&&(s+=`<li class="btn next" onclick="createPagination(totalPages, ${e+1})"><span>Next <i class="fas fa-angle-right"></i></span></li>`),t===1&&(tt.style.display="none"),N.innerHTML=s,s}const st=document.getElementById("id-modal-card");function ot(t){const e=document.createElement("div");return e.classList.add("product-card"),e.dataset.idcarts=t._id,e.addEventListener("click",()=>{w(t),st.classList.remove("is-hidden-card")}),e.innerHTML=`
  ...
  `,e}function at(t,e){return t.sort(()=>.5-Math.random()).slice(0,e)}D().then(t=>t.data).then(t=>{const e=at(t,2),s=document.getElementById("discountContainer");e.forEach(o=>{s.appendChild(ot(o))})}).catch(t=>{console.error(t.message)});const ct=document.querySelector(".shop-modal-close-btn");n.listCards.addEventListener("click",rt);async function rt(t){t.preventDefault();const{target:e}=t,s=e.closest(".filt-div-card");if(!s||e.closest(".filt-btn-card"))return;const r=s.dataset.idcarts;try{const c=await x(r);w(c),n.modalWindowId.classList.remove("is-hidden-card")}catch(c){console.log(c)}document.body.style.overflow="hidden"}ct.addEventListener("click",J);function J(){n.modalWindowId.classList.add("is-hidden-card"),document.body.style.overflow="scroll"}function nt(t){const{target:e}=t,s=e.closest(".shop-btn-card");if(h(),$(),!s)return;const o=s.dataset.idcards,r=s.dataset.check;console.log(r),J();const c=localStorage.getItem("cart"),a=JSON.parse(c);if(r==="false"){if(a){const l=a.find(d=>d._id===o);if(l){l.quantity+=1,localStorage.setItem("cart",JSON.stringify(a));return}a.push({_id:o,quantity:1}),localStorage.setItem("cart",JSON.stringify(a)),f();return}const i=[];i.push({_id:o,quantity:1}),localStorage.setItem("cart",JSON.stringify(i)),f()}else if(a&&a.find(l=>l._id===o)){const l=a.filter(d=>d._id!==o);localStorage.setItem("cart",JSON.stringify(l)),f();return}}n.addCartBtn.addEventListener("click",nt);const it=document.querySelector(".footer-form"),k=document.querySelector(".modal-backdrop"),q=document.querySelector(".modal-subscribe-container"),O=document.querySelector(".modal-unsubscription-container"),lt=document.querySelectorAll(".modal-close-btn"),dt=document.querySelector(".modal-container"),C=document.querySelector(".footer-btn-to-top"),ut=document.querySelector(".footer-container"),b=document.querySelector(".loader");dt.classList.add("is-hidden");const ft=t=>{t.forEach(e=>{e.isIntersecting?C.style.display="block":C.style.display="none"})};C.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});const pt=new IntersectionObserver(ft,{root:null,threshold:.5});pt.observe(ut);it.addEventListener("submit",mt);lt.forEach(t=>{t.addEventListener("click",gt)});async function mt(t){t.preventDefault();const s={email:document.querySelector(".footer-form-email").value};b.classList.remove("is-hidden");try{const o=await W(s);b.classList.add("is-hidden"),k.classList.remove("is-hidden"),O.classList.add("is-hidden"),q.classList.remove("is-hidden"),console.log(o.data)}catch(o){b.classList.add("is-hidden"),o.response&&o.response.status===409?(k.classList.remove("is-hidden"),O.classList.remove("is-hidden"),q.classList.add("is-hidden")):o.response&&o.response.status===400&&ht()}t.target.reset()}function gt(t){t.preventDefault(),k.classList.add("is-hidden")}function ht(){const t=document.querySelector(".error-message");t.style.display="block",setTimeout(()=>{t.style.display="none"},2e3)}
